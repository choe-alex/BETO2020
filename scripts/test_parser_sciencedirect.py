...
def parse_all(max_iters,driver,data,file):
    """
...
data = pd.read_csv('sd_test.txt',header=None,names=['url']) # 'sd_test.txt' is the local file containing a list of the scraped urls
...
parse_all(max_iters,driver,data,file)
