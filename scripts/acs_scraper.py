...
"""
This code is used to scrape ACS of publication urls and write them to
...
def build_annual_urls(search_term,max_pages):
    """
    This method takes the first ACS url and creates a list of
    urls which lead to the following pages on ACS which will be
    scraped. 
    """
